...
const Detail = () => {
  ...
  return (
    <>
    <div className=" flex flex-col items-center justify-center gap-8 mt-5 p-5">
    <Link to={'/'}>
    <div className=" flex items-center gap-2 mx-auto text-orange-500 font-bold group cursor-pointer">
      ...
      <p className="transition-all duration-500 group-hover:tracking-wider">Back To Home</p>
    </div>
    </Link>
      <div className="flex items-center gap-5">
        ...
        <div className=" flex flex-col items-start mt-5">
          ...
          <div className=" flex gap-3 mb-5">
            <button onClick={()=>setShow(true)} className="px-6 py-2 bg-teal-300 flex items-center gap-2 font-semibold rounded shadow">
              <TbClipboardText className="text-lg" />
              Instruction
            </button>
            <button onClick={()=>setShow(false)} className="px-6 py-2 bg-orange-300 flex items-center gap-2 font-semibold rounded shadow">
              <CiBoxList className="text-lg" />
              Ingredients
            </button>
          </div>
          <div className="h-[250px] overflow-y-scroll mb-3 custom-scrollbar">
            {show ? <p className="tracking-wide leading-7 font-medium">
